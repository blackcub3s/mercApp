...
\begin{document}
	...
	\chapter{Desarrollo del proyecto} %OBLIGAT
			...
			\section{Desarrollo back-end (Spring Boot)}
				...
				La parte de mercApp programada con Java (Spring Boot) se puede ver en el repositorio de GitHub del proyecto abriendo esta carpeta: \href{https://github.com/blackcub3s/mercApp/tree/main/APP%20WEB/__springboot__produccio__/app}{aquí}. Recomendamos al lector abrir este proyecto por aquí con IntelliJ. Se podrá ver entonces \textit{tres} rutas importantes (que las tienen todos los proyectos Spring Boot):
				...
				\begin{figure}[H]
					\centering
					\caption{Estructura del proyecto mercApp: imatges a la dreta.}
				...
				\subsubsection{src/main/resources: las clases del proyecto}
