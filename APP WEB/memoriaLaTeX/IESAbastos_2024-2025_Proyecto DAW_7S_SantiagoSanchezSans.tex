...
\begin{document}
	...
	\begin{center}
		...
		\begin{minipage}{0.8\textwidth}
			\large
			La redacción íntegra de esta memoria se ha hecho a mano. No se ha utilizado inteligencia artificial para la redacción de sus frases, ni revisión gramatical u ortográfica. Se insta al lector a tomarla en serio, pues es el resultado del esfuerzo y trabajo constante hechos de marzo a mayo de 2025.
		\end{minipage}
