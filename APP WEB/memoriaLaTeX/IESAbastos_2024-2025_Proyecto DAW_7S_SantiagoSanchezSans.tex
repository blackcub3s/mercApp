...
docker create -p 8000:8000 --name contFastApi back-end-fastapi
	...
	\begin{itemize}
		...
		\begin{itemize}
			\setlength{\itemsep}{.0em}
			\item \textbf{\textcolor{red}{[\texttt{/api/avaluaUsuari}]}}: \textit{end-point} de Spring Boot que evalúa si el correo electrónico introducido pertenece a un usuario registrado y qué permisos tiene.
			...
			\item\textbf{\textcolor{purple}{[\texttt{/api/parsea-y-guarda-pdfs-en-bbdd}]}}: \textit{end-point} de FastAPI que traslada al front-end un token de acceso expedido por Spring Boot con permisos a 1.
		\end{itemize}
