...
docker create -p 8000:8000 --name contFastApi back-end-fastapi
	...
	Al recibir el servidor de FastAPI una solicitud POST con los PDFs adjuntos y el Token de acceso con permisos a 0 en el endpoint /api/subir-tickets-pdf vamos a empezar una solicitud de extracción de datos de los tikets. A continuación mostramos exhaustivamente los 5 pasos o partes, que deberán ejecutarse con éxito y de forma SECUENCIAL para que el proceso funcione correctamente:
	...
	NDespués de esto El pas4 del front-end redirigirá automáticamente al dashboard.
