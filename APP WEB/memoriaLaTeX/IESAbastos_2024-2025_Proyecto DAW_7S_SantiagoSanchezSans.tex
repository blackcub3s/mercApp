...
\end{lstlisting}
	...
	NOTA: Podéis ver la función completa del controlador en el anexo \ref{sec:detallSeguretatControlador}
		...
		\textbf{	TO DO }
			...
			Es interesante hacer notar, y esto no lo sabía antes de programar la clase, es que una misma contraseña de entrada produce hash distintos! Es decir, el hashing no solo impide ver las contraseñas de los usuarios si se observa la BBDD, sino que también impide ver si dos usuarios tienen la misma contraseña (porque no encontraremos dos hashs iguales). Esto también hace que no podamos comparar con una función de comparación de strings el hash guardado de una contraseña en el momento del registro con el hash generado por un logueo. Esto hay que hacerlo con el metodo matches().
