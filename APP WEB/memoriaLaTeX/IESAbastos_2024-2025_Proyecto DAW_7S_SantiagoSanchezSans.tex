...
\begin{document}
	...
	\chapter{Desarrollo del proyecto} %OBLIGAT
			...
			Para esta aplicación vamos a tener una serie de vistas a las que el usuario va acceder en función del valor de la variable ``permisos'' en la tabla ``usuaris'' de mySql.
			
			Como hemos especificado en el Apartado de diseño, nos hemos inspirado para ello en un proceso de desarrollo inverso del proceso de registro de la plataforma NetFlix. El proceso de registro de netflix queda decentemente bien recogido en el diagrama del anexo (ver apartado \ref{sec:anexo_diagramaNetflix}) y puede consultarse también en uno delos repositorios de mi github (\href{https://www.github.com/miApp}{link}). El proceso de registro que utilizamos aquí es una derivación del mismo, pero en estre caso no se utilizan redirecciones a cartas de pago sino que redirigimos al usuario o bien a una página para darnos acceso a su gmail donde están los tikets digitales o al dashboard como vemos en el siguiente diagrama:ti
			
			\textbf{POSA DIAGRAMA ACTUALITZAT}
