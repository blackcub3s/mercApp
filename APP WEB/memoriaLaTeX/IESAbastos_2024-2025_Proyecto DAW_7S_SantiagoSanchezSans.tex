...
docker create -p 8000:8000 --name contFastApi back-end-fastapi
	...
	La validación de los datos se ha hecho con mucho cuidado antes de guardar los PDFs en el sistema de archivos del servidor. Será el usuario el que se descargue los tickets en pdf de su gmail. Pero no podemos confiar que sea responsable y suba archivos sin alterar.
