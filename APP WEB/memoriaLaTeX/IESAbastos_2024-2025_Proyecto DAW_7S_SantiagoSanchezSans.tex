...
docker create -p 8000:8000 --name contFastApi back-end-fastapi
	...
	Ahora el contenedor se podría acceder a través de otro contenedor, de kubernetes o como sea. Hemos usado la red 0.0.0.0, que lo permite. También permite que podamos consultar un endpoint de fastAPI corriendo dentro del contenedor mediante una solicitud get en localhost. En el moemnto de redactar esta parte teníamos en fastapi un endpoint muy sencillo a modo de demostración:
