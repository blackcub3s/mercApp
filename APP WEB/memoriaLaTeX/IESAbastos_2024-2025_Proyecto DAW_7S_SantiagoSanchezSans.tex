...
\end{lstlisting}
	...
	NOTA: Podéis ver la función completa del controlador en el anexo \ref{sec:detallSeguretatControlador}
			...
			Por ejemplo, para validar los datos de entrada a través del endpoint que recibe llamada del front-end para el incio de sesión (el endpoint ``api/login'' de Spring Boot, que podéis verlo en este  de \href{https://github.com/blackcub3s/mercApp/blob/4ddc34194763af7a246ffabb14146ad9b4b2c5db/APP%20WEB/__springboot__produccio__/app/src/main/java/miApp/app/Usuaris/controlador/UsuariControlador.java#104}{Snippet de GitHub} o en la siguiente imagen:
