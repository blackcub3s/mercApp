...
\end{lstlisting}
		...
		\begin{itemize}
			...
			\item \textbf{PASO 2:} Configurar el contexto de seguridad \textbf{(la security filter chain)} para que Spring Security reconozca los permisos. \\
