...
\begin{document}
	...
	\chapter{Desarrollo del proyecto} %OBLIGAT
			...
			\section{Herramientas de trabajo}
				...
				\subsection{GitHub del proyecto}
			...
			\subsection{Entornos de desarrollo}
				...
				Java SPRINGBOOT con IntelliJ Idea community edition
				Frontend y python con VScode
		
		\section{Estructura de la aplicación}
		
		\subsection{desarrollo del front-end}
		
		\subsection{desarrollo back-end}
