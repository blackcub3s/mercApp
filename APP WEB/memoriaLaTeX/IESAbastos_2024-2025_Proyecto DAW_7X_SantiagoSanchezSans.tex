...
\begin{document}
	...
	\chapter{Desarrollo del proyecto} %OBLIGAT
			...
			Existe un debate para ver si el token de acceso se debe mandar del cliente al servidor (cuando se hace el login) en el body de la response POST o bien en la header ``Authorization''. 
