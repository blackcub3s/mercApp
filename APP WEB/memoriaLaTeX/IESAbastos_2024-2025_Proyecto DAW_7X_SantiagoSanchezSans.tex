...
public static String generaAccesToken(String correu, 
	...
	.compact();
		...
		La tercera función \texttt{getClaims()} es la que utilizaremos en el Service de nuestra aplicación para poder autenticar usuarios. La clase puede ser consultada en el anexo \ref{sec:anexoCreacionYverificacionJWT} o en el GitHub del proyecto (\href{h}{text}link) (preferible esta opción porque hay la función main para testear las funciones de creación de token con control de excepciones).
