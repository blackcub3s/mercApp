...
\begin{itemize}
	...
	\item Contenerizar tanto back-end como front-end y automatizar despliegues, además de configurar correctamente CORS para permitir comunicaciones entre servicios en distintos puertos.
\end{itemize}
