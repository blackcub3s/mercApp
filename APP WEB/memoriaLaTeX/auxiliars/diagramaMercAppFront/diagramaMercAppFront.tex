...
\begin{document}
	...
	\node (dec4) [decisionBackend, below of=concedido, yshift=-.5cm] {¿Se pudo loguear?};
	...
	\node (dummy9) [below of=dec3, xshift=0cm, yshift=.3cm] {\textbf{\textcolor{red}{[/api/registraUsuari]}}};
...
\node (dummy9) [below of=dec1, xshift=0cm, yshift=.2cm] {\textbf{\textcolor{red}{[/api/avaluaUsuari]}}};
	...
	\draw [arrow] (pas2c) -- (dec4) node[midway, yshift=.05cm, xshift=.4cm] {No};
