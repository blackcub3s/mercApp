...
\begin{document}
	...
	\node (dummy9) [below of=dec1, xshift=0cm, yshift=.2cm] {\textbf{\textcolor{red}{[/api/avaluaUsuari]}}};
	\node (dummy12) [below of=dec4, xshift=1.2cm, yshift=1cm] {\textbf{\textcolor{red}{[/api/login]}}};
	\node (dummy13) [below of=dec5, xshift=1.2cm, yshift=1cm] {\textbf{\textcolor{red}{[/api/login]}}};
	\node (dummy14) [below of=jwtLOGIN, xshift=1.2cm, yshift=1cm] {\textbf{\textcolor{red}{[/api/login]}}};
	...
	\draw [arrow] (dec5) -- (dashboard) node[midway, yshift=.05cm, xshift=.4cm] {S\'{i}};
	\draw [arrow] (dec5) -- (pas4) node[midway, yshift=.3cm, xshift=3.7cm] {No};
