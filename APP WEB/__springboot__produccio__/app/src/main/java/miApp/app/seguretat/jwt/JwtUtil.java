...
public abstract class JwtUtil {
    ...
    //      Si el token es invalid (manipulat, firma incorrecta)
    //      tira excepcio (en poden haver varies).
    //      Si el token esta expirat, tira una excepcio ExpiredJwtException. VERIFICAT EMPIRICAMENT!
